                ...
                <div className="flex flex-col md:flex-row items-center gap-1.5 justify-between">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-1.5 text-sm text-zinc-500">
                        <div className="flex items-center gap-1.5">
                            <span>Feito por Carlos Silva :</span>
                            
                            <a className='text-blue-600 flex items-center gap-1.5' href="https://github.com/CarlosH505" target='blank' >Meu GitHub<IconBrandGithub size={28} stroke={1} /> </a>
